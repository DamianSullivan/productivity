...
WorkspaceNameApplet.prototype = {
    ...
    _init: function(metadata, orientation, panel_height, instanceId) {
        ...
        try {
            ...
            this.logError(
                this.uuid + " Main Applet Exception: " + e.toString());
        }
    },
    ...
    updateMenu: function() {
        ...
        for (let i = 0, workspaceCount = global.screen.n_workspaces;
                i < workspaceCount; i++) {
            ...
            menuItem.connect('activate',
                Lang.bind(this, function() { this.activateWorkspace(workspace); }));
